...
/* 
 * Changed -Maniac
 * Added Draw_Char_Sized from Q2ACE (http://www.savageservers.com/q2ace/)
 */
void    Draw_Char_Sized (int x, int y, int c, int xsize, int ysize);
// End
...
refexport_t GetRefAPI (refimport_t rimp )
{
	 ...
	 */
	re.DrawCharSized = Draw_Char_Sized;
	//End 
